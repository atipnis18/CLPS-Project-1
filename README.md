...
An interesting point to note is that racial categories and sex categories are assigned to individuals by the police officer -- for example, drivers labelled "Hispanic" are *racialized* as "Hispanic" by the police officer themselves. Given this example, drivers who are not visually profiled as "Hispanic" racially (despite Hispanic being an ethnic group) could still identify as Hispanic. Race, particularly, is not inherent to an individual, but *assigned*.  ![CLPS 0950 Hours](https://user-images.githubusercontent.com/101745330/159997826-c1f9156f-c56d-4638-91a8-d54ee702a150.png)
