...
[M_asday, dec_asday,stats_asday] = mnrfit(predictor_vector, dummyviolation_citation)
...
dummyviolation_citation = categorical(dummyviolation_citation);
predictor_vector = [predictor1, predictor2];
[M_blday, dec_blday,stats_blday] = mnrfit(predictor_vector, dummyviolation_citation)
...
dummyviolation_citation = categorical(dummyviolation_citation);
predictor_vector = [predictor1, predictor2];
[M_whday, dec_whday,stats_whday] = mnrfit(predictor_vector, dummyviolation_citation)
...
dummyviolation_citation = categorical(dummyviolation_citation);
predictor_vector = [predictor1, predictor2];
[M_hispday, dec_hispday,stats_hispday] = mnrfit(predictor_vector, dummyviolation_citation)
...
dummyviolation_citation = categorical(dummyviolation_citation);
predictor_vector = [predictor1, predictor2];
[M_asmale, dec_asmale,stats_asmale] = mnrfit(predictor_vector, dummyviolation_citation)
...
dummyviolation_citation = categorical(dummyviolation_citation);
predictor_vector = [predictor1, predictor2];
[M_blmale, dec_blmale,stats_blmale] = mnrfit(predictor_vector, dummyviolation_citation)
...
dummyviolation_citation = categorical(dummyviolation_citation);
predictor_vector = [predictor1, predictor2];
[M_wmale, dec_wmale,stats_wmale] = mnrfit(predictor_vector, dummyviolation_citation)
